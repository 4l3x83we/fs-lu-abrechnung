...
@else
    <div class="grid grid-cols-1 gap-4">
        <div class="col-span-1">
            <x-custom.forms.file id="image" wire:model="image" wire:loading.remove/>
        </div>
